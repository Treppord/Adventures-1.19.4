...
import com.trep.addon.screen.FabricatorScreenHandler;
...
public class FabricatorBlockEntity extends LockableContainerBlockEntity
{
    ...
    {
        super(AdventureBlockEntities.SMITHING_ANVIL_BLOCK_ENTITY, blockPos, blockState);
    ...
    public static void tick(World world, BlockPos blockPos, BlockState state, FabricatorBlockEntity entity) {
        if(world.isClient()) {
            return;
        }
    }
