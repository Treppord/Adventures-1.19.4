...
import com.trep.addon.entity.client.render.*;
...
public class TestAddonClient implements PswgClientAddon {
	...
	public void onPswgClientReady() {
		...
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.BLUE_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.GREEN_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.YELLOW_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.ORANGE_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.PURPLE_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.RED_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.CYAN_KYBER_CRYSTAL, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.C3PO_BODY, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.C3PO_HEAD, RenderLayer.getCutout());
		BlockRenderLayerMap.INSTANCE.putBlock(AdventureBlocks.C3PO_LEGGINGS, RenderLayer.getCutout());
